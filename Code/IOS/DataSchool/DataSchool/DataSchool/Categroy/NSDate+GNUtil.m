...
//  MarketEleven
//
//  Created by Bergren Lam on 9/25/14.
...
+(NSDate *)dateByAddDay:(NSInteger)days {
    NSCalendar *calendar = [NSCalendar currentCalendar];
    
    NSDate *currentDate = [NSDate date];
    
    NSDate *date = [currentDate dateByAddingTimeInterval:24 * 3600 * days];
...
+ (NSDateComponents *)remainTimeFromDate:(NSDate *)fromDate expireDate:(NSDate *)expireDate {
    NSCalendar *calendar = [NSCalendar currentCalendar];
    
    
    
    unsigned int unitFlags = (NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond);
    
    
    NSDateComponents *components = [calendar components:unitFlags fromDate:fromDate toDate:expireDate options:0];
