...
//fwb add
//+(NSString *)stringByEncodingString:(NSString *)encodeString;
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
+(NSData *)decodeStringToData:(NSString *)string;

//fwb add
+(NSString *)decodeStringToString:(NSString *)string;
...
//fwb added
+(NSString *)stringByWebSafeEncodingString:(NSString *)str
                                    padded:(BOOL)padded;
//end
...
//fwb added
+(NSString *)webSafeDecodeStringToString:(NSString *)string ;
//end
@end