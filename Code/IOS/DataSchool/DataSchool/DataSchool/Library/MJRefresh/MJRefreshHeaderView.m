...
- (void)layoutSubviews
{
    ...
    CGPoint p;
    p.y = self.statusLabel.center.y;
    p.x = (statusWidth - self.activityView.frame.size.width) * 0.5 - 35;
...
- (void)setLastUpdateTimeLabelHidden:(BOOL)hidden {
    self.lastUpdateTimeLabel.hidden = hidden;
}
