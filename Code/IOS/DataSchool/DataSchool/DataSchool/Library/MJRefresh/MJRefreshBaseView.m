...
@interface  MJRefreshBaseView()
{
    ...
    __weak UIImageView *_animateImage;
...
- (UIImageView *)arrowImage
{
    if (!_arrowImage) {
        ...
        // lewis
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loding-d"]];
...
- (UIView *)activityView
{
    if (!_activityView) {
        ...
        UIImage *img = [UIImage imageNamed:@"loding"]; // loding_small
        CGSize s = img.size;
        
        UIView *v = [[UIView alloc] initWithFrame:CGRectMake(0, 0, s.width, s.height)];
        v.backgroundColor = [UIColor clearColor];
        
        UIImageView *animateImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, s.width, s.height)];
        animateImage.image = img;
        
        img = [UIImage imageNamed:@"loding_car_small"];
        s = img.size;
        UIImageView *carImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, s.width, s.height)];
        carImage.image = img;
        
        [v addSubview:_animateImage = animateImage];
        [v addSubview:carImage];
        carImage.center = animateImage.center;
        
        //v.center = self.arrowImage.center;
        
        [self addSubview:_activityView = v];
...
- (void)startAnimating
{
    ...
    [_animateImage.layer addAnimation:rotationAnimation forKey:@"rotationAnimation"];
}
...
- (void)stopAnimating
{
    ...
    [_animateImage.layer removeAnimationForKey:@"rotationAnimation"];
}
