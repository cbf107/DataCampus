...
#define kBadgeStrokeColor [UIColor orangeColor]
...
{    
    ...
    CGFloat viewWidth = textWidth + kBadgeTextSideMargin + (kMarginToDrawInside -5.0);
    CGFloat viewHeight = kBadgeHeight + (kMarginToDrawInside -6);
